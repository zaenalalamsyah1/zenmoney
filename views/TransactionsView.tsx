...
export const TransactionsView: React.FC<TransactionsViewProps> = ({ transactions, onEditTransaction }) => {
  ...
  return (
    // Increased pt to 16 for safe area
    <div className="pt-16 px-6 pb-32 h-full overflow-y-auto no-scrollbar bg-slate-50">
      <h1 className="text-2xl font-bold text-slate-900 mb-4">History</h1>

      <div className="space-y-3 mb-6 sticky top-0 bg-slate-50 pt-1 z-10 pb-2">
