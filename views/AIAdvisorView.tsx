...
export const AIAdvisorView: React.FC<AIAdvisorViewProps> = ({ transactions, messages, setMessages, onClearChat }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      {/* Increased top padding to pt-14 for better mobile header clearance */}
      <div className="px-6 pt-14 pb-4 border-b border-slate-100 flex justify-between items-center bg-white sticky top-0 z-20">
